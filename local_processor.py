...
B2_KEY_ID = os.getenv("B2_KEY_ID", "valor_por_defecto")
B2_APP_KEY = os.getenv("B2_APP_KEY", "valor_por_defecto")
B2_BUCKET_ID = os.getenv("B2_BUCKET_ID", "valor_por_defecto") # Or B2_BUCKET, based on your choice above

logger.info(f"DEBUG: B2_KEY_ID loaded: '{B2_KEY_ID}'")
logger.info(f"DEBUG: B2_APP_KEY loaded: '{B2_APP_KEY[:5]}...'") # Show first few chars for security
logger.info(f"DEBUG: B2_BUCKET_ID loaded: '{B2_BUCKET_ID}'") # Check this too
